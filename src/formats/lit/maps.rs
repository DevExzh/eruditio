...
pub(super) static ATTRS_BODY: &[(u16, &str)] = &[
    ...
    (0x93ae, "topmargin"), (0x93af, "rightmargin"),
    (0x93b0, "bottommargin"), (0x93b1, "leftmargin"),
    (0x93b6, "bgproperties"), (0x93d8, "scroll"),
    (0x977b, "onselect"), (0x9791, "onload"), (0x9792, "onunload"),
    (0x9798, "onbeforeunload"), (0x97b3, "onbeforeprint"),
...
pub(super) static ATTRS_IFRAME: &[(u16, &str)] = &[
    ...
    (0x8bbe, "marginwidth"), (0x8bbf, "marginheight"),
    (0x8bc0, "noresize"), (0x8bc1, "scrolling"),
...
pub(super) static ATTRS_IMG: &[(u16, &str)] = &[
    ...
    (0x03f6, "start"), (0x07d3, "ismap"), (0x07d9, "usemap"),
    (0x8001, "name"), (0x8006, "width"), (0x8007, "height"),
    (0x8046, "title"), (0x804a, "align"), (0x804b, "style"),
    (0x83ea, "class"), (0x83eb, "id"),
...
pub(super) static ATTRS_INPUT: &[(u16, &str)] = &[
    ...
    (0x07de, "vspace"), (0x07df, "hspace"), (0x07e0, "lowsrc"),
    (0x07e1, "vrml"), (0x07e2, "dynsrc"), (0x07e4, "loop"),
    (0x07e5, "start"), (0x8001, "name"), (0x8006, "width"),
    (0x8007, "height"), (0x804a, "align"), (0x93ee, "value"),
    (0x977b, "onselect"), (0x978d, "onabort"), (0x978e, "onerror"),
...
pub(super) static ATTRS_TAG63: &[(u16, &str)] = &[
    ...
    (0x8006, "width"), (0x8007, "height"),
    (0x9785, "onbounce"), (0x978b, "onfinish"), (0x978c, "onstart"),
    (0xfe0c, "bgcolor"),
];
// <meta> (65)
...
pub(super) static ATTRS_TABLE: &[(u16, &str)] = &[
    ...
    (0x8046, "title"), (0x804a, "align"), (0x804b, "style"),
    (0x83ea, "class"), (0x83eb, "id"), (0x938a, "background"),
...
pub(super) static ATTRS_TD: &[(u16, &str)] = &[
    ...
    (0x804b, "style"), (0x83ea, "class"), (0x83eb, "id"),
    (0x938a, "background"), (0x938e, "nowrap"),
    (0x93a5, "bordercolor"), (0x93a6, "bordercolorlight"),
...
pub fn html_tag_attr(tag_index: usize, code: u16) -> Option<&'static str> {
    let table: &[(u16, &str)] = match tag_index {
        ...
        6 => ATTRS_APPLET,
        7 => ATTRS_AREA,
        8 | 13 | 29 | 34 | 51 | 56 | 78 | 82 | 83 | 86 | 87 | 88 | 89
        | 91 | 92 | 103 | 104 | 106 => ATTRS_STYLE_CLASS_ID,
        9 => ATTRS_BASE,
        10 => ATTRS_BASEFONT,
        12 => ATTRS_BGSOUND,
