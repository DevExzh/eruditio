...
fn test_tcr_parsing() {
    ...
    // 0: "H"
    data.push(1); data.push(b'H');
    // 1: "e"
    data.push(1); data.push(b'e');
    // 2: "l"
    data.push(1); data.push(b'l');
    // 3: "o"
    data.push(1); data.push(b'o');
    // 4: " "
    data.push(1); data.push(b' ');
    // 5: "W"
    data.push(1); data.push(b'W');
    // 6: "r"
    data.push(1); data.push(b'r');
    // 7: "d"
    data.push(1); data.push(b'd');
    ...
    assert_eq!(book.metadata.title, Some("Unknown TCR Document".to_string()));
